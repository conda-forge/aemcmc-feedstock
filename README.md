...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aemcmc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14930&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aemcmc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aemcmc` can be installed with:

```
conda install aemcmc
```

It is possible to list all of the versions of `aemcmc` available on your platform with:
